...
const translations = {
  es: {
    ...
    privacy: {
      ...
      sec1Text: "<strong>Titular:</strong> Marcos Luna Dev<br><strong>DNI/NIF:</strong> [añádelo si quieres que conste]<br><strong>Domicilio:</strong> Madrid, España<br><strong>Correo de contacto en materia de protección de datos:</strong> info@codedevpro.com",
  ...
  en: {
    ...
    privacy: {
      ...
      sec1Text: "<strong>Owner:</strong> Marcos Luna Dev<br><strong>DNI/NIF:</strong> [DNI/NIF (optional)]<br><strong>Address:</strong> Madrid, Spain<br><strong>Data protection contact email:</strong> info@codedevpro.com",
